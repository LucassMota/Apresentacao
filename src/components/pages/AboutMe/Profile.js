      ...
      <ul>
        ...
        <div className='about__description'>
          <h1>
            ...
            assuntos, foi na programação que recentemente descobri uma nova
            paixão. De forma autodidata, ando melhorando meus conhecimentos como
            desenvolvedor e procurando minha primeira oportunidade como
            desenvolvedor profissional para aprender muito mais.
          </h1>
        </div>
      </ul>
    </div>
