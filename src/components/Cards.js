...
import cardImage3 from './images/cronometro-estudos.JPG';
            ...
            <div className="cards__container">
                <div className="cards__wrapper">
                    <ul className='cards__items'>
                        ...
                        <CardItem
                        src={cardImage3}
                        text='Cronometro de estudos e pausa com tempo final acumulado para produtividade nos estudos'
                        label='Backend'
                        path='/CronometroEstudos'
                        />
                    </ul>
                </div>
            </div>
